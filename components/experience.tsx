...
const experiences = [
  {
    ...
    period: "2023 - Present",
    description: "Teaching English to high school students, focusing on grammar, vocabulary, and conversation skills. Helped students improve their English proficiency through interactive lessons and personalized feedback.",
    icon: <Users className="h-6 w-6" />,
  },
  {
    title: "Teaching Assistant",
    period: "2022 - 2023",
    description: "Assisted senior English teachers with classroom management, lesson planning, and student assessments. Gained valuable experience in teaching methodologies and classroom dynamics.",
    icon: <BookOpen className="h-6 w-6" />,
  },
  {
    title: "Started Teacher Training",
    period: "2022",
    description: "Enrolled in the English teacher training program, studying language pedagogy, educational psychology, and teaching methodologies. Focused on developing essential teaching skills and knowledge.",
    icon: <Calendar className="h-6 w-6" />,
  },
  {
    title: "English Proficiency Certification",
    period: "2021",
    description: "Achieved C1 level certification in English, demonstrating advanced language proficiency in reading, writing, speaking, and listening. This qualification prepared me for a career in English education.",
